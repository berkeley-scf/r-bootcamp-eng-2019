...
The GitHub site ([https://github.com/berkeley-scf/r-bootcamp-eng-2019](https://github.com/berkeley-scf/r-bootcamp-eng-2019)) is the main site for the bootcamp. It has information on logistics, software installation, and is the master repository for materials for the modules.
...
Your counseloRs are: Simal Irmak (D-Lab), Emily Grabowski (D-Lab), and Evan Muzzall (D-Lab).
...
- "Repository URL": https://github.com/berkeley-scf/r-bootcamp-eng-2019
- "Project Directory Name": r-bootcamp-eng-2019 (or something else of your choosing)
...
- `git clone https://github.com/berkeley-scf/r-bootcamp-eng-2019`

Then to update from the repository to get any changes we've made:

- `cd /directory/where/you/put/the/repository/r-bootcamp-eng-2019`
- `git pull`

## As a zip file

If you don't want to bother using Git or have problems, simply download a zip file with all the material from [https://github.com/berkeley-scf/r-bootcamp-eng-2019/archive/master.zip](https://github.com/berkeley-scf/r-bootcamp-eng-2019/archive/master.zip).
...
* To Evan, Simal, and Emily.
* To D-Lab for logistical support.
* To the Masters in Engineering program for sponsorship and room reservation.

# We want your feedback (even if you leave early)!

During the break tomorrow, we'll ask everyone to fill out a feedback form, but if you leave early, please also fill it out:
[https://berkeley.qualtrics.com/jfe/form/SV_0Jy1rtGhm3a7lHf](https://berkeley.qualtrics.com/jfe/form/SV_0Jy1rtGhm3a7lHf)
